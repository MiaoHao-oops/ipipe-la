...
#define CPU_FEATURE_EXTIOI_DECODE	23	/* CPU has extioi int pin decode mode */
#define CPU_FEATURE_FLATMODE		24	/* CPU has flatmode */
...
#define LOONGARCH_CPU_EXTIOI_DECODE	BIT_ULL(CPU_FEATURE_EXTIOI_DECODE)
