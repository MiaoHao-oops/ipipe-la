...
{
	csr_xchgq(idx, CSR_TLBIDX_IDXM, LOONGARCH_CSR_TLBIDX);
}

static inline unsigned int read_csr_pagesize(void)
{
	return (csr_readq(LOONGARCH_CSR_TLBIDX) & CSR_TLBIDX_SIZEM) >> CSR_TLBIDX_SIZE;
}

static inline void write_csr_pagesize(unsigned int size)
{
	csr_xchgq(size << CSR_TLBIDX_SIZE, CSR_TLBIDX_SIZEM, LOONGARCH_CSR_TLBIDX);
}
...
#define read_csr_tlbidx()		csr_readq(LOONGARCH_CSR_TLBIDX)
#define write_csr_tlbidx(val)		csr_writeq(val, LOONGARCH_CSR_TLBIDX)
#define read_csr_euen()			csr_readq(LOONGARCH_CSR_EUEN)
#define write_csr_euen(val)		csr_writeq(val, LOONGARCH_CSR_EUEN)
#define read_csr_cpuid()		csr_readq(LOONGARCH_CSR_CPUID)
...
#define read_csr_stlbpgsize()		csr_readq(LOONGARCH_CSR_STLBPGSIZE)
#define write_csr_stlbpgsize(val)	csr_writeq(val, LOONGARCH_CSR_STLBPGSIZE)
#define read_csr_rvacfg()		csr_readq(LOONGARCH_CSR_RVACFG)
#define write_csr_rvacfg(val)		csr_writeq(val, LOONGARCH_CSR_RVACFG)
#define write_csr_tintclear(val)	csr_writeq(val, LOONGARCH_CSR_TINTCLR)
...
/* Guest related CSRS */
#define read_csr_gtlbc()		csr_readq(LOONGARCH_CSR_GTLBC)
#define write_csr_gtlbc(val)		csr_writeq(val, LOONGARCH_CSR_GTLBC)
#define read_csr_trgp()			csr_readq(LOONGARCH_CSR_TRGP)
#define read_csr_gcfg()			csr_readq(LOONGARCH_CSR_GCFG)
#define write_csr_gcfg(val)		csr_writeq(val, LOONGARCH_CSR_GCFG)
#define read_csr_gstat()		csr_readq(LOONGARCH_CSR_GSTAT)
#define write_csr_gstat(val)		csr_writeq(val, LOONGARCH_CSR_GSTAT)
#define read_csr_gintc()		csr_readq(LOONGARCH_CSR_GINTC)
#define write_csr_gintc(val)		csr_writeq(val, LOONGARCH_CSR_GINTC)
#define read_csr_gcntc()		csr_readq(LOONGARCH_CSR_GCNTC)
#define write_csr_gcntc(val)		csr_writeq(val, LOONGARCH_CSR_GCNTC)

/* Guest CSRS read and write */
#define read_gcsr_crmd()		gcsr_readq(LOONGARCH_CSR_CRMD)
#define write_gcsr_crmd(val)		gcsr_writeq(val, LOONGARCH_CSR_CRMD)
#define read_gcsr_prmd()		gcsr_readq(LOONGARCH_CSR_PRMD)
#define write_gcsr_prmd(val)		gcsr_writeq(val, LOONGARCH_CSR_PRMD)
#define read_gcsr_coprocessor()		gcsr_readq(LOONGARCH_CSR_EUEN)
#define write_gcsr_coprocessor(val)	gcsr_writeq(val, LOONGARCH_CSR_EUEN)
#define read_gcsr_misc()		gcsr_readq(LOONGARCH_CSR_MISC)
#define write_gcsr_misc(val)		gcsr_writeq(val, LOONGARCH_CSR_MISC)
#define read_gcsr_ecfg()		gcsr_readq(LOONGARCH_CSR_ECFG)
#define write_gcsr_ecfg(val)		gcsr_writeq(val, LOONGARCH_CSR_ECFG)
#define read_gcsr_estat()		gcsr_readq(LOONGARCH_CSR_ESTAT)
#define write_gcsr_estat(val)		gcsr_writeq(val, LOONGARCH_CSR_ESTAT)
#define read_gcsr_era()			gcsr_readq(LOONGARCH_CSR_ERA)
#define write_gcsr_era(val)		gcsr_writeq(val, LOONGARCH_CSR_ERA)
#define read_gcsr_badv()		gcsr_readq(LOONGARCH_CSR_BADV)
#define write_gcsr_badv(val)		gcsr_writeq(val, LOONGARCH_CSR_BADV)
#define read_gcsr_badi()		gcsr_readq(LOONGARCH_CSR_BADI)
#define write_gcsr_badi(val)		gcsr_writeq(val, LOONGARCH_CSR_BADI)
#define read_gcsr_eentry()		gcsr_readq(LOONGARCH_CSR_EENTRY)
#define write_gcsr_eentry(val)		gcsr_writeq(val, LOONGARCH_CSR_EENTRY)

#define read_gcsr_tlbidx()		gcsr_readq(LOONGARCH_CSR_TLBIDX)
#define write_gcsr_tlbidx(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBIDX)
#define read_gcsr_tlbhi()		gcsr_readq(LOONGARCH_CSR_TLBEHI)
#define write_gcsr_tlbhi(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBEHI)
#define read_gcsr_tlblo0()		gcsr_readq(LOONGARCH_CSR_TLBELO0)
#define write_gcsr_tlblo0(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBELO0)
#define read_gcsr_tlblo1()		gcsr_readq(LOONGARCH_CSR_TLBELO1)
#define write_gcsr_tlblo1(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBELO1)

#define read_gcsr_asid()		gcsr_readq(LOONGARCH_CSR_ASID)
#define write_gcsr_asid(val)		gcsr_writeq(val, LOONGARCH_CSR_ASID)
#define read_gcsr_pgdl()		gcsr_readq(LOONGARCH_CSR_PGDL)
#define write_gcsr_pgdl(val)		gcsr_writeq(val, LOONGARCH_CSR_PGDL)
#define read_gcsr_pgdh()		gcsr_readq(LOONGARCH_CSR_PGDH)
#define write_gcsr_pgdh(val)		gcsr_writeq(val, LOONGARCH_CSR_PGDH)
#define write_gcsr_pgd(val)		gcsr_writeq(val, LOONGARCH_CSR_PGD)
#define read_gcsr_pgd()			gcsr_readq(LOONGARCH_CSR_PGD)
#define read_gcsr_pwctl0()		gcsr_readq(LOONGARCH_CSR_PWCTL0)
#define write_gcsr_pwctl0(val)		gcsr_writeq(val, LOONGARCH_CSR_PWCTL0)
#define read_gcsr_pwctl1()		gcsr_readq(LOONGARCH_CSR_PWCTL1)
#define write_gcsr_pwctl1(val)		gcsr_writeq(val, LOONGARCH_CSR_PWCTL1)
#define read_gcsr_stlbpgsize()		gcsr_readq(LOONGARCH_CSR_STLBPGSIZE)
#define write_gcsr_stlbpgsize(val)	gcsr_writeq(val, LOONGARCH_CSR_STLBPGSIZE)
#define read_gcsr_rvacfg()		gcsr_readq(LOONGARCH_CSR_RVACFG)
#define write_gcsr_rvacfg(val)		gcsr_writeq(val, LOONGARCH_CSR_RVACFG)

#define read_gcsr_cpuid()		gcsr_readq(LOONGARCH_CSR_CPUID)
#define write_gcsr_cpuid(val)		gcsr_writeq(val, LOONGARCH_CSR_CPUID)
#define read_gcsr_prcfg1()		gcsr_readq(LOONGARCH_CSR_PRCFG1)
#define write_gcsr_prcfg1(val)		gcsr_writeq(val, LOONGARCH_CSR_PRCFG1)
#define read_gcsr_prcfg2()		gcsr_readq(LOONGARCH_CSR_PRCFG2)
#define write_gcsr_prcfg2(val)		gcsr_writeq(val, LOONGARCH_CSR_PRCFG2)
#define read_gcsr_prcfg3()		gcsr_readq(LOONGARCH_CSR_PRCFG3)
#define write_gcsr_prcfg3(val)		gcsr_writeq(val, LOONGARCH_CSR_PRCFG3)

#define read_gcsr_kscratch0()		gcsr_readq(LOONGARCH_CSR_KS0)
#define write_gcsr_kscratch0(val)	gcsr_writeq(val, LOONGARCH_CSR_KS0)
#define read_gcsr_kscratch1()		gcsr_readq(LOONGARCH_CSR_KS1)
#define write_gcsr_kscratch1(val)	gcsr_writeq(val, LOONGARCH_CSR_KS1)
#define read_gcsr_kscratch2()		gcsr_readq(LOONGARCH_CSR_KS2)
#define write_gcsr_kscratch2(val)	gcsr_writeq(val, LOONGARCH_CSR_KS2)
#define read_gcsr_kscratch3()		gcsr_readq(LOONGARCH_CSR_KS3)
#define write_gcsr_kscratch3(val)	gcsr_writeq(val, LOONGARCH_CSR_KS3)
#define read_gcsr_kscratch4()		gcsr_readq(LOONGARCH_CSR_KS4)
#define write_gcsr_kscratch4(val)	gcsr_writeq(val, LOONGARCH_CSR_KS4)
#define read_gcsr_kscratch5()		gcsr_readq(LOONGARCH_CSR_KS5)
#define write_gcsr_kscratch5(val)	gcsr_writeq(val, LOONGARCH_CSR_KS5)
#define read_gcsr_kscratch6()		gcsr_readq(LOONGARCH_CSR_KS6)
#define write_gcsr_kscratch6(val)	gcsr_writeq(val, LOONGARCH_CSR_KS6)
#define read_gcsr_kscratch7()		gcsr_readq(LOONGARCH_CSR_KS7)
#define write_gcsr_kscratch7(val)	gcsr_writeq(val, LOONGARCH_CSR_KS7)

#define read_gcsr_timerid()		gcsr_readq(LOONGARCH_CSR_TMID)
#define write_gcsr_timerid(val)		gcsr_writeq(val, LOONGARCH_CSR_TMID)
#define read_gcsr_timercfg()		gcsr_readq(LOONGARCH_CSR_TCFG)
#define write_gcsr_timercfg(val)	gcsr_writeq(val, LOONGARCH_CSR_TCFG)
#define read_gcsr_timertick()		gcsr_readq(LOONGARCH_CSR_TVAL)
#define write_gcsr_timertick(val)	gcsr_writeq(val, LOONGARCH_CSR_TVAL)
#define read_gcsr_timeroffset()		gcsr_readq(LOONGARCH_CSR_CNTC)
#define write_gcsr_timeroffset(val)	gcsr_writeq(val, LOONGARCH_CSR_CNTC)

#define read_gcsr_llbctl()		gcsr_readq(LOONGARCH_CSR_LLBCTL)
#define write_gcsr_llbctl(val)		gcsr_writeq(val, LOONGARCH_CSR_LLBCTL)

#define read_gcsr_tlbrentry()		gcsr_readq(LOONGARCH_CSR_TLBRENTRY)
#define write_gcsr_tlbrentry(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRENTRY)
#define read_gcsr_tlbrbadv()		gcsr_readq(LOONGARCH_CSR_TLBRBADV)
#define write_gcsr_tlbrbadv(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRBADV)
#define read_gcsr_tlbrera()		gcsr_readq(LOONGARCH_CSR_TLBRERA)
#define write_gcsr_tlbrera(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBRERA)
#define read_gcsr_tlbrsave()		gcsr_readq(LOONGARCH_CSR_TLBRSAVE)
#define write_gcsr_tlbrsave(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRSAVE)
#define read_gcsr_tlbrelo0()		gcsr_readq(LOONGARCH_CSR_TLBRELO0)
#define write_gcsr_tlbrelo0(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRELO0)
#define read_gcsr_tlbrelo1()		gcsr_readq(LOONGARCH_CSR_TLBRELO1)
#define write_gcsr_tlbrelo1(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRELO1)
#define read_gcsr_tlbrehi()		gcsr_readq(LOONGARCH_CSR_TLBREHI)
#define write_gcsr_tlbrehi(val)		gcsr_writeq(val, LOONGARCH_CSR_TLBREHI)
#define read_gcsr_tlbrprmd()		gcsr_readq(LOONGARCH_CSR_TLBRPRMD)
#define write_gcsr_tlbrprmd(val)	gcsr_writeq(val, LOONGARCH_CSR_TLBRPRMD)

#define read_gcsr_directwin0()		gcsr_readq(LOONGARCH_CSR_DMWIN0)
#define write_gcsr_directwin0(val)	gcsr_writeq(val, LOONGARCH_CSR_DMWIN0)
#define read_gcsr_directwin1()		gcsr_readq(LOONGARCH_CSR_DMWIN1)
#define write_gcsr_directwin1(val)	gcsr_writeq(val, LOONGARCH_CSR_DMWIN1)
#define read_gcsr_directwin2()		gcsr_readq(LOONGARCH_CSR_DMWIN2)
#define write_gcsr_directwin2(val)	gcsr_writeq(val, LOONGARCH_CSR_DMWIN2)
#define read_gcsr_directwin3()		gcsr_readq(LOONGARCH_CSR_DMWIN3)
#define write_gcsr_directwin3(val)	gcsr_writeq(val, LOONGARCH_CSR_DMWIN3)
...
#define set_csr_estat(val)	\
	csr_xchgq(val, val, LOONGARCH_CSR_ESTAT)
#define clear_csr_estat(val)	\
	csr_xchgq(~(val), val, LOONGARCH_CSR_ESTAT)
#define set_gcsr_estat(val)	\
	gcsr_xchgq(val, val, LOONGARCH_CSR_ESTAT)
