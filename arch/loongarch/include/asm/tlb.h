...
static inline void invtlb_noinfo(u32 op, u32 info, u64 addr)
{
	__asm__ __volatile__(
		"parse_r addr,%0\n\t"
...
static inline void invtlb_noaddr(u32 op, u32 info, u64 addr)
{
	__asm__ __volatile__(
		"parse_r info,%0\n\t"
...
static inline void invtlb_all_atomic(u32 op, u32 info, u64 addr)
{
	invtlb_all(op, info, addr);
}

static inline void invtlb_noinfo_atomic(u32 op, u32 info, u64 addr)
{
	invtlb_noinfo(op, info, addr);
}

static inline void invtlb_atomic(u32 op, u32 info, u64 addr)
{
	invtlb(op, info, addr);
}
