...
/**
 * union loongarch_vdso_data - Data provided by the kernel for the VDSO.
...
static inline u32 vdso_data_read_begin(const union loongarch_vdso_data *data)
{
	u32 seq;
...
static inline bool vdso_data_read_retry(const union loongarch_vdso_data *data,
					u32 start_seq)
{
	/* Paired with smp_wmb() in vdso_data_write_*(). */
	smp_rmb();
...
static inline void vdso_data_write_begin(union loongarch_vdso_data *data)
{
	++data->seq_count;
...
static inline void vdso_data_write_end(union loongarch_vdso_data *data)
{
