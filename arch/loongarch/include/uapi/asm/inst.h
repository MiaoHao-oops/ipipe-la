...
enum reg0_op {
	tlbinv_op = 0x19208, gtlbinv_op=0x19208,
	tlbflush_op = 0x19209, gtlbflush_op=0x19209,
	tlbp_op = 0x1920a, gtlbp_op=0x1920a,
	tlbr_op = 0x1920b, gtlbr_op=0x1920b,
	tlbwi_op = 0x1920c, gtlbwi_op=0x1920c,
	tlbwr_op = 0x1920d, gtlbwr_op=0x1920d,
	eret_op = 0x1920e,
};

enum reg0i15_op {
	break_op = 0x54, dbgcall_op, syscall_op, hypcall_op,
	wait_op = 0xc91, dbar_op = 0x70e4, ibar_op,
};
...
enum reg2i12_op {
	...
	cache_op = 0x18, xvldreplb_op = 0xca,
...
enum reg3_op {
	...
	ldxbu_op = 0x7040, ldxhu_op = 7048, ldxwu_op = 0x7050,
