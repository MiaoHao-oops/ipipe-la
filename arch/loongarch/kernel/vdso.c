...
static union loongarch_vdso_data vdso_data __page_aligned_data;
	...
	struct task_struct *next)
{
	...
	if (test_tsk_thread_flag(next, TIF_SINGLESTEP))
		vdso_data.pcpu_data[cpu_id].singlestep_mask = 1;
	else
		vdso_data.pcpu_data[cpu_id].singlestep_mask = 0;
