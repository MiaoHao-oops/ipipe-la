...
static unsigned long watch_csrrd(unsigned int reg)
{
	switch (reg) {
	case LOONGARCH_CSR_IB0ADDR:
		return csr_readq(LOONGARCH_CSR_IB0ADDR);
	case LOONGARCH_CSR_IB1ADDR:
		return csr_readq(LOONGARCH_CSR_IB1ADDR);
	case LOONGARCH_CSR_IB2ADDR:
		return csr_readq(LOONGARCH_CSR_IB2ADDR);
	case LOONGARCH_CSR_IB3ADDR:
		return csr_readq(LOONGARCH_CSR_IB3ADDR);
	case LOONGARCH_CSR_IB4ADDR:
		return csr_readq(LOONGARCH_CSR_IB4ADDR);
	case LOONGARCH_CSR_IB5ADDR:
		return csr_readq(LOONGARCH_CSR_IB5ADDR);
	case LOONGARCH_CSR_IB6ADDR:
		return csr_readq(LOONGARCH_CSR_IB6ADDR);
	case LOONGARCH_CSR_IB7ADDR:
		return csr_readq(LOONGARCH_CSR_IB7ADDR);

	case LOONGARCH_CSR_IB0MASK:
		return csr_readq(LOONGARCH_CSR_IB0MASK);
	case LOONGARCH_CSR_IB1MASK:
		return csr_readq(LOONGARCH_CSR_IB1MASK);
	case LOONGARCH_CSR_IB2MASK:
		return csr_readq(LOONGARCH_CSR_IB2MASK);
	case LOONGARCH_CSR_IB3MASK:
		return csr_readq(LOONGARCH_CSR_IB3MASK);
	case LOONGARCH_CSR_IB4MASK:
		return csr_readq(LOONGARCH_CSR_IB4MASK);
	case LOONGARCH_CSR_IB5MASK:
		return csr_readq(LOONGARCH_CSR_IB5MASK);
	case LOONGARCH_CSR_IB6MASK:
		return csr_readq(LOONGARCH_CSR_IB6MASK);
	case LOONGARCH_CSR_IB7MASK:
		return csr_readq(LOONGARCH_CSR_IB7MASK);

	case LOONGARCH_CSR_IB0ASID:
		return csr_readq(LOONGARCH_CSR_IB0ASID);
	case LOONGARCH_CSR_IB1ASID:
		return csr_readq(LOONGARCH_CSR_IB1ASID);
	case LOONGARCH_CSR_IB2ASID:
		return csr_readq(LOONGARCH_CSR_IB2ASID);
	case LOONGARCH_CSR_IB3ASID:
		return csr_readq(LOONGARCH_CSR_IB3ASID);
	case LOONGARCH_CSR_IB4ASID:
		return csr_readq(LOONGARCH_CSR_IB4ASID);
	case LOONGARCH_CSR_IB5ASID:
		return csr_readq(LOONGARCH_CSR_IB5ASID);
	case LOONGARCH_CSR_IB6ASID:
		return csr_readq(LOONGARCH_CSR_IB6ASID);
	case LOONGARCH_CSR_IB7ASID:
		return csr_readq(LOONGARCH_CSR_IB7ASID);

	case LOONGARCH_CSR_IB0CTL:
		return csr_readq(LOONGARCH_CSR_IB0CTL);
	case LOONGARCH_CSR_IB1CTL:
		return csr_readq(LOONGARCH_CSR_IB1CTL);
	case LOONGARCH_CSR_IB2CTL:
		return csr_readq(LOONGARCH_CSR_IB2CTL);
	case LOONGARCH_CSR_IB3CTL:
		return csr_readq(LOONGARCH_CSR_IB3CTL);
	case LOONGARCH_CSR_IB4CTL:
		return csr_readq(LOONGARCH_CSR_IB4CTL);
	case LOONGARCH_CSR_IB5CTL:
		return csr_readq(LOONGARCH_CSR_IB5CTL);
	case LOONGARCH_CSR_IB6CTL:
		return csr_readq(LOONGARCH_CSR_IB6CTL);
	case LOONGARCH_CSR_IB7CTL:
		return csr_readq(LOONGARCH_CSR_IB7CTL);

	case LOONGARCH_CSR_DB0ADDR:
		return csr_readq(LOONGARCH_CSR_DB0ADDR);
	case LOONGARCH_CSR_DB1ADDR:
		return csr_readq(LOONGARCH_CSR_DB1ADDR);
	case LOONGARCH_CSR_DB2ADDR:
		return csr_readq(LOONGARCH_CSR_DB2ADDR);
	case LOONGARCH_CSR_DB3ADDR:
		return csr_readq(LOONGARCH_CSR_DB3ADDR);
	case LOONGARCH_CSR_DB4ADDR:
		return csr_readq(LOONGARCH_CSR_DB4ADDR);
	case LOONGARCH_CSR_DB5ADDR:
		return csr_readq(LOONGARCH_CSR_DB5ADDR);
	case LOONGARCH_CSR_DB6ADDR:
		return csr_readq(LOONGARCH_CSR_DB6ADDR);
	case LOONGARCH_CSR_DB7ADDR:
		return csr_readq(LOONGARCH_CSR_DB7ADDR);

	case LOONGARCH_CSR_DB0MASK:
		return csr_readq(LOONGARCH_CSR_DB0MASK);
	case LOONGARCH_CSR_DB1MASK:
		return csr_readq(LOONGARCH_CSR_DB1MASK);
	case LOONGARCH_CSR_DB2MASK:
		return csr_readq(LOONGARCH_CSR_DB2MASK);
	case LOONGARCH_CSR_DB3MASK:
		return csr_readq(LOONGARCH_CSR_DB3MASK);
	case LOONGARCH_CSR_DB4MASK:
		return csr_readq(LOONGARCH_CSR_DB4MASK);
	case LOONGARCH_CSR_DB5MASK:
		return csr_readq(LOONGARCH_CSR_DB5MASK);
	case LOONGARCH_CSR_DB6MASK:
		return csr_readq(LOONGARCH_CSR_DB6MASK);
	case LOONGARCH_CSR_DB7MASK:
		return csr_readq(LOONGARCH_CSR_DB7MASK);

	case LOONGARCH_CSR_DB0ASID:
		return csr_readq(LOONGARCH_CSR_DB0ASID);
	case LOONGARCH_CSR_DB1ASID:
		return csr_readq(LOONGARCH_CSR_DB1ASID);
	case LOONGARCH_CSR_DB2ASID:
		return csr_readq(LOONGARCH_CSR_DB2ASID);
	case LOONGARCH_CSR_DB3ASID:
		return csr_readq(LOONGARCH_CSR_DB3ASID);
	case LOONGARCH_CSR_DB4ASID:
		return csr_readq(LOONGARCH_CSR_DB4ASID);
	case LOONGARCH_CSR_DB5ASID:
		return csr_readq(LOONGARCH_CSR_DB5ASID);
	case LOONGARCH_CSR_DB6ASID:
		return csr_readq(LOONGARCH_CSR_DB6ASID);
	case LOONGARCH_CSR_DB7ASID:
		return csr_readq(LOONGARCH_CSR_DB7ASID);

	case LOONGARCH_CSR_DB0CTL:
		return csr_readq(LOONGARCH_CSR_DB0CTL);
	case LOONGARCH_CSR_DB1CTL:
		return csr_readq(LOONGARCH_CSR_DB1CTL);
	case LOONGARCH_CSR_DB2CTL:
		return csr_readq(LOONGARCH_CSR_DB2CTL);
	case LOONGARCH_CSR_DB3CTL:
		return csr_readq(LOONGARCH_CSR_DB3CTL);
	case LOONGARCH_CSR_DB4CTL:
		return csr_readq(LOONGARCH_CSR_DB4CTL);
	case LOONGARCH_CSR_DB5CTL:
		return csr_readq(LOONGARCH_CSR_DB5CTL);
	case LOONGARCH_CSR_DB6CTL:
		return csr_readq(LOONGARCH_CSR_DB6CTL);
	case LOONGARCH_CSR_DB7CTL:
		return csr_readq(LOONGARCH_CSR_DB7CTL);
...
void watch_csrwr(unsigned long val, unsigned int reg)
{
	...
	case LOONGARCH_CSR_IB0ADDR:
		...
		break;
	case LOONGARCH_CSR_IB1ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB1ADDR);
		break;
	case LOONGARCH_CSR_IB2ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB2ADDR);
		break;
	case LOONGARCH_CSR_IB3ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB3ADDR);
		break;
	case LOONGARCH_CSR_IB4ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB4ADDR);
		break;
	case LOONGARCH_CSR_IB5ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB5ADDR);
		break;
	case LOONGARCH_CSR_IB6ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB6ADDR);
		break;
	case LOONGARCH_CSR_IB7ADDR:
		csr_writeq(val, LOONGARCH_CSR_IB7ADDR);
		break;

	case LOONGARCH_CSR_IB0MASK:
		csr_writeq(val, LOONGARCH_CSR_IB0MASK);
		break;
	case LOONGARCH_CSR_IB1MASK:
		csr_writeq(val, LOONGARCH_CSR_IB1MASK);
		break;
	case LOONGARCH_CSR_IB2MASK:
		csr_writeq(val, LOONGARCH_CSR_IB2MASK);
		break;
	case LOONGARCH_CSR_IB3MASK:
		csr_writeq(val, LOONGARCH_CSR_IB3MASK);
		break;
	case LOONGARCH_CSR_IB4MASK:
		csr_writeq(val, LOONGARCH_CSR_IB4MASK);
		break;
	case LOONGARCH_CSR_IB5MASK:
		csr_writeq(val, LOONGARCH_CSR_IB5MASK);
		break;
	case LOONGARCH_CSR_IB6MASK:
		csr_writeq(val, LOONGARCH_CSR_IB6MASK);
		break;
	case LOONGARCH_CSR_IB7MASK:
		csr_writeq(val, LOONGARCH_CSR_IB7MASK);
		break;

	case LOONGARCH_CSR_IB0ASID:
		csr_writeq(val, LOONGARCH_CSR_IB0ASID);
		break;
	case LOONGARCH_CSR_IB1ASID:
		csr_writeq(val, LOONGARCH_CSR_IB1ASID);
		break;
	case LOONGARCH_CSR_IB2ASID:
		csr_writeq(val, LOONGARCH_CSR_IB2ASID);
		break;
	case LOONGARCH_CSR_IB3ASID:
		csr_writeq(val, LOONGARCH_CSR_IB3ASID);
		break;
	case LOONGARCH_CSR_IB4ASID:
		csr_writeq(val, LOONGARCH_CSR_IB4ASID);
		break;
	case LOONGARCH_CSR_IB5ASID:
		csr_writeq(val, LOONGARCH_CSR_IB5ASID);
		break;
	case LOONGARCH_CSR_IB6ASID:
		csr_writeq(val, LOONGARCH_CSR_IB6ASID);
		break;
	case LOONGARCH_CSR_IB7ASID:
		csr_writeq(val, LOONGARCH_CSR_IB7ASID);
		break;

	case LOONGARCH_CSR_IB0CTL:
		csr_writeq(val, LOONGARCH_CSR_IB0CTL);
		break;
	case LOONGARCH_CSR_IB1CTL:
		csr_writeq(val, LOONGARCH_CSR_IB1CTL);
		break;
	case LOONGARCH_CSR_IB2CTL:
		csr_writeq(val, LOONGARCH_CSR_IB2CTL);
		break;
	case LOONGARCH_CSR_IB3CTL:
		csr_writeq(val, LOONGARCH_CSR_IB3CTL);
		break;
	case LOONGARCH_CSR_IB4CTL:
		csr_writeq(val, LOONGARCH_CSR_IB4CTL);
		break;
	case LOONGARCH_CSR_IB5CTL:
		csr_writeq(val, LOONGARCH_CSR_IB5CTL);
		break;
	case LOONGARCH_CSR_IB6CTL:
		csr_writeq(val, LOONGARCH_CSR_IB6CTL);
		break;
	case LOONGARCH_CSR_IB7CTL:
		csr_writeq(val, LOONGARCH_CSR_IB7CTL);
		break;
	...
	case LOONGARCH_CSR_DB0ADDR:
		...
		break;
	case LOONGARCH_CSR_DB1ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB1ADDR);
		break;
	case LOONGARCH_CSR_DB2ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB2ADDR);
		break;
	case LOONGARCH_CSR_DB3ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB3ADDR);
		break;
	case LOONGARCH_CSR_DB4ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB4ADDR);
		break;
	case LOONGARCH_CSR_DB5ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB5ADDR);
		break;
	case LOONGARCH_CSR_DB6ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB6ADDR);
		break;
	case LOONGARCH_CSR_DB7ADDR:
		csr_writeq(val, LOONGARCH_CSR_DB7ADDR);
		break;

	case LOONGARCH_CSR_DB0MASK:
		csr_writeq(val, LOONGARCH_CSR_DB0MASK);
		break;
	case LOONGARCH_CSR_DB1MASK:
		csr_writeq(val, LOONGARCH_CSR_DB1MASK);
		break;
	case LOONGARCH_CSR_DB2MASK:
		csr_writeq(val, LOONGARCH_CSR_DB2MASK);
		break;
	case LOONGARCH_CSR_DB3MASK:
		csr_writeq(val, LOONGARCH_CSR_DB3MASK);
		break;
	case LOONGARCH_CSR_DB4MASK:
		csr_writeq(val, LOONGARCH_CSR_DB4MASK);
		break;
	case LOONGARCH_CSR_DB5MASK:
		csr_writeq(val, LOONGARCH_CSR_DB5MASK);
		break;
	case LOONGARCH_CSR_DB6MASK:
		csr_writeq(val, LOONGARCH_CSR_DB6MASK);
		break;
	case LOONGARCH_CSR_DB7MASK:
		csr_writeq(val, LOONGARCH_CSR_DB7MASK);
		break;

	case LOONGARCH_CSR_DB0ASID:
		csr_writeq(val, LOONGARCH_CSR_DB0ASID);
		break;
	case LOONGARCH_CSR_DB1ASID:
		csr_writeq(val, LOONGARCH_CSR_DB1ASID);
		break;
	case LOONGARCH_CSR_DB2ASID:
		csr_writeq(val, LOONGARCH_CSR_DB2ASID);
		break;
	case LOONGARCH_CSR_DB3ASID:
		csr_writeq(val, LOONGARCH_CSR_DB3ASID);
		break;
	case LOONGARCH_CSR_DB4ASID:
		csr_writeq(val, LOONGARCH_CSR_DB4ASID);
		break;
	case LOONGARCH_CSR_DB5ASID:
		csr_writeq(val, LOONGARCH_CSR_DB5ASID);
		break;
	case LOONGARCH_CSR_DB6ASID:
		csr_writeq(val, LOONGARCH_CSR_DB6ASID);
		break;
	case LOONGARCH_CSR_DB7ASID:
		csr_writeq(val, LOONGARCH_CSR_DB7ASID);
		break;

	case LOONGARCH_CSR_DB0CTL:
		csr_writeq(val, LOONGARCH_CSR_DB0CTL);
		break;
	case LOONGARCH_CSR_DB1CTL:
		csr_writeq(val, LOONGARCH_CSR_DB1CTL);
		break;
	case LOONGARCH_CSR_DB2CTL:
		csr_writeq(val, LOONGARCH_CSR_DB2CTL);
		break;
	case LOONGARCH_CSR_DB3CTL:
		csr_writeq(val, LOONGARCH_CSR_DB3CTL);
		break;
	case LOONGARCH_CSR_DB4CTL:
		csr_writeq(val, LOONGARCH_CSR_DB4CTL);
		break;
	case LOONGARCH_CSR_DB5CTL:
		csr_writeq(val, LOONGARCH_CSR_DB5CTL);
		break;
	case LOONGARCH_CSR_DB6CTL:
		csr_writeq(val, LOONGARCH_CSR_DB6CTL);
		break;
	case LOONGARCH_CSR_DB7CTL:
		csr_writeq(val, LOONGARCH_CSR_DB7CTL);
		break;
