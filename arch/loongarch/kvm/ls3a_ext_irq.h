...
#define IOCSR_EXTIOI_ADDR	LOONGARCH_IOCSR_EXTIOI_NODEMAP_BASE
...
#define EXTIOI_NODETYPE_START	(LOONGARCH_IOCSR_EXTIOI_NODEMAP_BASE - IOCSR_EXTIOI_ADDR)
#define EXTIOI_NODETYPE_END	(EXTIOI_NODETYPE_START + 0x20)
#define EXTIOI_IPMAP_START	(LOONGARCH_IOCSR_EXTIOI_IPMAP_BASE - IOCSR_EXTIOI_ADDR)
#define EXTIOI_IPMAP_END	(EXTIOI_IPMAP_START + 0x8)
#define EXTIOI_ENABLE_START	(LOONGARCH_IOCSR_EXTIOI_EN_BASE - IOCSR_EXTIOI_ADDR)
#define EXTIOI_ENABLE_END	(EXTIOI_ENABLE_START + 0x20)
#define EXTIOI_BOUNCE_START	(LOONGARCH_IOCSR_EXTIOI_BOUNCE_BASE - IOCSR_EXTIOI_ADDR)
...
#define EXTIOI_COREMAP_START	(LOONGARCH_IOCSR_EXTIOI_ROUTE_BASE - IOCSR_EXTIOI_ADDR)
