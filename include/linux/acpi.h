...
#if defined(CONFIG_X86) || defined(CONFIG_IA64) || defined(CONFIG_CPU_LOONGSON64) || defined(CONFIG_CPU_LOONGSON3)
...
#if defined(CONFIG_X86) || defined(CONFIG_CPU_LOONGSON64) || defined(CONFIG_CPU_LOONGSON3)
