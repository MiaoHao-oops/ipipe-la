...
/* on Loongarch, 0 indicates auto, 1 forces VZ ASE, 2 forces trap & emulate */
#define KVM_VM_LOONGARCH_AUTO	0
#define KVM_VM_LOONGARCH_VZ		1
#define KVM_VM_LOONGARCH_TE		2
